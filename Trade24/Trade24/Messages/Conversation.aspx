<%@ Page Language="C#" MasterPageFile="~/Layouts/Default.Login.Master" AutoEventWireup="true" CodeBehind="Conversation.aspx.cs" Inherits="Trade24.Messages.Conversation" %>
                    ...
                    <asp:Repeater ID="rptConversation" runat="server">
                        <ItemTemplate>
                            <div class="media conversation">
                                <a href="/Message/Conversation.aspx?id=<%# ((MessageBO)Container.DataItem).PartnerID %>" runat="server">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><a href="/Messages/Conversation.aspx?id=<%# ((MessageBO)Container.DataItem).PartnerID %>"><%# ((MessageBO)Container.DataItem).PartnerName() %></a></h5>
                                        <small><%# ((MessageBO)Container.DataItem).Created_at %></small><br>
                                        <small><%# ((MessageBO)Container.DataItem).Content %></small>
                                    </div>
                                </a>
                            </div>
                        </ItemTemplate>
